...
import {type PopOverProps} from './template';
import type PopOverTemplate from './template';
import useClickOutside from '@hooks/useClickOutside';
import useCreateComponentRef from '@hooks/useCreateComponentRef';
import behavior, {type B} from '@internals/behavior';

export const {Behavior, useBehavior} = behavior<PopOverProps, typeof PopOverTemplate>(props => {
  const {open, innerRef, ...templateProps} = props;
  ...
  const {ref, events} = useCreateComponentRef<B<PopOverProps, typeof PopOverTemplate>>(innerRef);
