...
import { UIScrollContainerProps } from "./UIScrollContainer";
import { UIScrollContainerTemplateProps } from "./UIScrollContainerTemplate";

interface UIScrollContainerBehaviorProps extends UIScrollContainerProps {
  Template: React.FC<UIScrollContainerTemplateProps>
}

const UIScrollContainerBehavior: React.FC<UIScrollContainerBehaviorProps> = (props) => {
...
export default UIScrollContainerBehavior