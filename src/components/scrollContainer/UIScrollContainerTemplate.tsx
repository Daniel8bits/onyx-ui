...
export interface UIScrollContainerTemplateProps extends UIScrollContainerProps {
...
const UIScrollContainerTemplate: React.FC<UIScrollContainerTemplateProps> = (props) => (
  <div 
...
export default UIScrollContainerTemplate